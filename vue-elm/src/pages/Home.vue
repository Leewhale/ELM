    ...
    <div>
        <div class="content">
            <div class="home-head">
                ...
                <div class="small-nav">
                    <a href="#" v-for="item in hotSearch" :key="item.word">{{item.word}}</a>
                </div>
            </div>
            <swiper :options="swiperOption" class="lunbo-box">
                <swiper-slide>
                     <div class="home-nav">
                        <div v-for="(item, index) in navList" :key="item.id" v-if="index<8">
                            <img src="../imgs/nav1.jpeg">
                            <p>{{item.name}}</p>
                        </div>
                    </div>
                </swiper-slide>
...
.shop-info-box .shop-logo img {
    width: 100%;
}

.shop-info-box .shop-main {
    width: 80%;
    height: 100%;
}
...
.shop-main-level .level-star {
    display: inline-block;
    font-size: 0;
}

.shop-main-level .level-star img {
    width: 0.7rem;
}

.shop-main-level .level-count {
    font-size: 0.7rem;
    color: #ff6000;
}

.shop-main-level .level-sale {
    font-size: 0.75rem;
    color: #666;
}
...
.shop-main-info p span {
    font-size: 0.7rem;
    color: #939393;
}

.shop-main-info .info-show {
    position: absolute;
    top: 0;
    right: 0;
...
.shop-main-info .info-show span {
    font-size: 0.7rem;
    color: #999;
}

.shop-main-info .info-show img {
    vertical-align: top;
    margin-top: 0.4rem;
}
.lunbo-box{
