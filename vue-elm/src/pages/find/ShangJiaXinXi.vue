...
<div class="shop_list">
  <div class="shop_header">
    ...
    <ul class='shop_ad_box'>
      <li class="shop_ad" v-for='item in storeIn.activities'>
...
import shangjiaxinxiShop from '../home/shangjiaxinxi_shop'
import shangjiaxinxiPingjia from '../home/shangjiaxinxi_pingjia'
...
.shop_header {
  color: #fff;
  background: url(../../../static/imgs/find/header_bg.png) no-repeat;
  background-size: 100%;
}
