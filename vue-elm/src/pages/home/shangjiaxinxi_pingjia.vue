...
<div class="comments">
  ...
  <div class="ping_j">
    <div class="ping_j_type">
      <span :class="{typeactive:activeClass==index}" v-for='(item,index) in manYi' @click="getPingJia(item.record_type);activeClass=index">{{item.name+'('+item.amount+')'}}</span>
    </div>
    <div class="ping_j_con">
      <div class="pJ" v-for='item in pingJia'>
        <div class="pj_un_icon">
          <img src="../../../static/imgs/headerElephant.png" alt="">
        </div>
        <div class="pj_con">
